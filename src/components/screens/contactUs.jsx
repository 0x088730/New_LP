    ...
    return (
        <div className="relative md:w-full h-[900px] sm:h-[900px] md:h-[1223px] xl:h-[1223px] flex flex-col justify-start items-center mt-[-9rem] sm:mt-[-21rem] md:mt-[-28rem] lg:mt-[-32rem] xl:mt-[-50rem] 2xl:mt-[-48rem]">
            <LazyImage
                ...
                onLoad={() => props.handleImageLoad("assets/images/backgrounds/contact.svg")}
                ...
                <div className="flex flex-col lg:flex-row items-center gap-y-6 my-6 md:gap-x-6 z-10">
                    <div className="relative w-[300px] xl:w-[420px] h-[170px] xl:h-[225px] flex flex-col justify-center items-center">
                        <div className="absolute w-full h-full -z-10">
                            <LazyImage
                                src="assets/images/member/member1.svg"
                                onLoad={() => props.handleImageLoad("assets/images/member/member1.svg")}
                    ...
                    <div className="relative w-[300px] xl:w-[420px] h-[170px] xl:h-[225px] flex flex-col justify-center items-center">
                        <div className="absolute w-full h-full -z-10">
                            <LazyImage
                                src="assets/images/member/member2.svg"
                                onLoad={() => props.handleImageLoad("assets/images/member/member2.svg")}
                                className="w-full h-full -z-10"
                            />
                        </div>
                    ...
                    <div className="relative w-[300px] xl:w-[420px] h-[170px] xl:h-[225px] flex flex-col justify-center items-center">
                        <div className="absolute w-full h-full -z-10">
                            <LazyImage
                                src="assets/images/member/member3.svg"
                                onLoad={() => props.handleImageLoad("assets/images/member/member3.svg")}
                                className="w-full h-full -z-10"
                            />
                        </div>
            ...
            <LazyImage
                src="assets/images/rock8.svg"
                onLoad={() => props.handleImageLoad("assets/images/rock8.svg")}
                className="absolute left-0 -bottom-4 w-[40%]"
            />
            <LazyImage
                src="assets/images/rock9.svg"
                onLoad={() => props.handleImageLoad("assets/images/rock9.svg")}
                className="absolute right-0 -bottom-4 w-1/2 h-[30%]"
            />
            <LazyImage
                src="assets/images/characters/character-6.svg"
                onLoad={() => props.handleImageLoad("assets/images/characters/character-6.svg")}
            ...
            <div className="absolute left-12 sm:left-0 bottom-20 flex flex-col sm:flex-row justify-around w-full mb-2 z-30">
                ...
                <div className="flex items-center my-8 sm:my-0"><LazyLoadImage effect="black-and-white" draggable="false" src="assets/images/sms.svg" alt="" className="me-2" />ADM@SOURCE-CODE.WORK</div>
                <div className="flex gap-x-4 items-center">
                    <LazyImage
                        src="assets/images/tw.svg"
                        onLoad={() => props.handleImageLoad("assets/images/tw.svg")}
                        className="cursor-pointer w-10"
                        onClick={() => goUrl("https://twitter.com/Crypto_Showdown")}
                    />
                    <LazyImage
                        src="assets/images/tg.svg"
                        onLoad={() => props.handleImageLoad("assets/images/tg.svg")}
                        className="cursor-pointer w-10"
                        onClick={() => goUrl("https://t.me/cryptoshowdown")}
                    />
                    <LazyImage
                        src="assets/images/discord.svg"
                        onLoad={() => props.handleImageLoad("assets/images/discord.svg")}
                        className="cursor-pointer w-10"
